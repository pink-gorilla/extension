...
(def lib 'org.pinkgorilla/extension)
  ...
  [[:licenses
   ...
   [:developers
    [:developer
     [:name "pink-gorilla"]]]
   [:scm
    [:url "https://github.com/pink-gorilla/extension"]
    [:connection "scm:git:git://github.com/pink-gorilla/extension.git"]
    [:developerConnection "scm:git:ssh://git@github.com/pink-gorilla/extension.git"]]])
